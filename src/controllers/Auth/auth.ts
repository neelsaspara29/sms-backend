...
import { admin_create_mail, email_verification_mail, forgot_password_mail, reqInfo, responseMessage } from '../../helper'
...
export const signUp = async (req: Request, res: Response) => {
    ...
    try {
        ...
        console.log(body, "-----------------------> signup body");
         ...
         await admin_create_mail(body, pass).then(result => { return result }).catch(error => { return error })
            
         return res.status(200).json(new apiResponse(200, "Admin Created Successfully", {}, {}));
